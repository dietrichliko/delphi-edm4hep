#!/bin/bash -x
# Run EDM4hep conversion on a file of the dataset short94_c2/C1
...
DATA_FILE="/eos/experiment/delphi/castor2015/tape/Y13709/Y13709.1.al"

# Configuration file path
CONFIG_FILE="${PROJECT_DIR}/config/delphi_edm4hep.toml"

# Output file for EDM4hep conversion
OUTPUT_FILE="${PROJECT_DIR}/output/short94_c2.edm4hep.root"
